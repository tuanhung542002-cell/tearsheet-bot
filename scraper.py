    ...
    async with httpx.AsyncClient(
        ...
        if not data:
            ...
            return (
                ...
                f"Operating CF FY24: 28,707.58 VNDm\n"
                f"Operating CF FY23: -28,628.18 VNDm\n"
                f"Operating CF FY22: -51,323.53 VNDm\n"
                f"Operating CF FY21: -24,324.23 VNDm\n"
                f"Capex FY25: -143,881.89 VNDm\n"
                f"Capex FY24: -93,652.85 VNDm\n"
                f"Capex FY23: -78,165.76 VNDm\n"
                f"Capex FY22: -49,355.66 VNDm\n"
                f"Capex FY21: -12,968.80 VNDm\n"
                f"Free CF FY25: 94,457.95 VNDm\n"
                f"DA (Depreciation) FY25: 41,449.68 VNDm\n"
                f"DA FY24: 23,453.65 VNDm\n"
                f"DA FY23: 23,097.02 VNDm\n"
                f"DA FY22: 12,069.97 VNDm\n"
                f"DA FY21: 6,146.59 VNDm\n"
                f"Employees: 1,467\n"
                f"Founded: 2015\n"
                f"Sector: Food Retail\n"
                f"Legal form: Joint Stock Company\n"
                f"Address: 571 Huynh Tan Phat, HCMC\n"
                f"Revenue FY21 gross: 285,364.96 VNDm | Net revenue: 278,590.32 VNDm\n"
                f"Revenue FY22 gross: 484,380.45 VNDm | Net revenue: 482,788.82 VNDm\n"
                f"Revenue FY23 gross: 1,084,768.51 VNDm | Net revenue: 1,080,616.08 VNDm\n"
                f"Revenue FY24 gross: 2,022,778.39 VNDm | Net revenue: 2,016,162.99 VNDm\n"
                f"Revenue FY25 gross: 3,453,566.57 VNDm | Net revenue: 3,444,082.11 VNDm\n"
                f"EBIT FY21: -31,892.95 VNDm (-11.2%)\n"
                f"EBIT FY22: -59,645.93 VNDm (-12.3%)\n"
                f"EBIT FY23: -78,737.01 VNDm (-7.3%)\n"
                f"EBIT FY24: 925.41 VNDm (0.05%)\n"
                f"EBIT FY25: 82,401.56 VNDm (2.4%)\n"
                f"Total Assets FY21: 92,135.10 VNDm\n"
                f"Total Assets FY22: 164,337.34 VNDm\n"
                f"Total Assets FY23: 362,723.91 VNDm\n"
                f"Total Assets FY24: 484,922.40 VNDm\n"
                f"Total Assets FY25: 884,658.23 VNDm\n"
                f"Total Equity FY21: 24,446.15 VNDm\n"
                f"Total Equity FY22: 55,850.53 VNDm\n"
                f"Total Equity FY23: 26,967.99 VNDm\n"
                f"Total Equity FY24: 74,852.75 VNDm\n"
                f"Total Equity FY25: 178,597.30 VNDm\n"
                f"Total Debt FY21: 37,661.54 VNDm\n"
                f"Total Debt FY22: 41,984.87 VNDm\n"
                f"Total Debt FY23: 149,866.10 VNDm\n"
                f"Total Debt FY24: 157,339.16 VNDm\n"
                f"Total Debt FY25: 235,224.09 VNDm\n"
                f"Cash FY21: 31,016.27 VNDm\n"
                f"Cash FY22: 24,795.90 VNDm\n"
                f"Cash FY23: 78,289.05 VNDm\n"
                f"Cash FY24: 45,987.99 VNDm\n"
                f"Cash FY25: 210,378.59 VNDm\n"
            )
